...
const assemble_successfully = document.getElementById(
  'assembled_successfully_container'
);
const assembled_successfully_Btn = document.getElementById(
  'assembled_successfully_Btn'
);
